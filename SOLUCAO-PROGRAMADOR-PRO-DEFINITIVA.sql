-- =====================================================
-- SOLUÇÃO PROGRAMADOR PRO - DEFINITIVA E COMPLETA
-- =====================================================
...
BEGIN
    ...
    -- Limpar contas existentes (se houver)
    DELETE FROM financial_accounts WHERE company_id = empresa_id;
...
USING (company_id = 'd4e26386-fc32-472d-ac2a-deddc3efce27'::uuid);
