...
-- 2. DESABILITAR RESTRIÇÕES TEMPORARIAMENTE
SET session_replication_role = replica;

-- 3. LIMPAR TODOS OS DADOS DE TESTE (ORDEM CORRETA)
DELETE FROM financial_transactions;
DELETE FROM financial_accounts;
DELETE FROM sessoes_caixa;
DELETE FROM companies;

-- 4. HABILITAR RESTRIÇÕES NOVAMENTE
...
-- 6. RESETAR SEQUÊNCIAS (se existirem)
DO $$
BEGIN
...
-- 7. VERIFICAR SE ESTÁ REALMENTE LIMPO
SELECT 
