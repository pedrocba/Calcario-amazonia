-- =====================================================
-- SISTEMA FINANCEIRO CORRIGIDO - SEM ERROS DE TIPO
-- =====================================================
-- Execute este script no Supabase SQL Editor

-- 1. REMOVER TABELAS EXISTENTES SE HOUVER CONFLITOS
DROP TABLE IF EXISTS financial_transactions CASCADE;
DROP TABLE IF EXISTS financial_accounts CASCADE;
DROP TABLE IF EXISTS sessoes_caixa CASCADE;
DROP TABLE IF EXISTS companies CASCADE;

-- 2. CRIAR TABELA COMPANIES COM ID TEXT (COMPATÍVEL)
...
-- 3. CRIAR TABELA FINANCIAL_ACCOUNTS COMPLETA
...
-- 4. CRIAR TABELA FINANCIAL_TRANSACTIONS COMPLETA
...
-- 11. INSERIR CONTAS FINANCEIRAS DE EXEMPLO
...
-- 12. INSERIR CONTAS A PAGAR DE EXEMPLO
...
-- 13. INSERIR CONTAS A RECEBER DE EXEMPLO
INSERT INTO financial_transactions (company_id, type, amount, description, due_date, status, category, notes)
VALUES 
