...
-- 2. TESTAR INSERÇÃO DE DADOS SIMPLES
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE 'Erro ao inserir produto: %', SQLERRM;
END $$;
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE 'Erro ao inserir categoria: %', SQLERRM;
END $$;
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE 'Erro ao inserir contato: %', SQLERRM;
END $$;
...
-- 5. RESULTADO FINAL
SELECT 'TESTE DE ISOLAMENTO SIMPLES CONCLUÍDO!' as status;
