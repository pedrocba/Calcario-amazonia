-- ==============================================
-- ISOLAMENTO SIMPLES SEM TABELA EMPRESAS
-- ==============================================
...
-- 2. Adicionar coluna empresa_id na tabela profiles (sem foreign key)
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS empresa_id UUID;

-- 3. Definir empresa_id padrão para CBA
UPDATE profiles 
...
-- 5. Configurar tabela companies (sem foreign key)
...
-- 6. Configurar tabela products (sem foreign key)
...
-- 7. Configurar tabela contacts (sem foreign key)
...
-- 8. Configurar tabela vendas (sem foreign key)
...
-- 9. Configurar tabela product_categories (sem foreign key)
